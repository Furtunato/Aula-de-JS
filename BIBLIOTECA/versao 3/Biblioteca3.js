...
function registrarVendar() {
    ...
    if (titulo && preco && comprador) {
        ...
        // Limpar os campos após registrar a venda
        document.getElementById('venda-titulo').value = '';
        document.getElementById('venda-preco').value = '';
        document.getElementById('venda-comprador').value = '';
    } else {
        alert('Por favor, preencha todos os campos para registrar a venda.');
...
function gerarRelatorioVendas() {
    ...
    tabelaRelatorio.innerHTML = ''; // Limpar tabela anterior
